...
useEffect(() => {
  setHeights(Array.from({ length: 24 }, () => 30 + Math.random() * 70));
}, []);
              ...
              <Card className="overflow-hidden">
                ...
                <CardContent className="p-6 bg-black text-green-400 font-mono text-sm">
                  <div className="space-y-2">
                    <div>$ Waku-validator init</div>
                    <div>Initializing validator node...</div>
                    <div>Connected to Waku-Waku Hub</div>
                    <div>Validator ID: Waku_val_8a72f...</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="border-t pt-8 flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-4 md:mb-0">
              ...
              <span className="font-medium">Waku-Waku</span>
            </div>
